...
| 数据库表名 | privacy_log |
| 所属模块 | privacy |
| API基础路径 | /api/privacy/privacylog |
...
**请求信息**
- 方法：GET
- 路径：/api/privacy/privacylog/:id
- 描述：根据ID获取单个PrivacyLog的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/privacy/privacylog
- 描述：分页获取PrivacyLog列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/privacy/privacylog/batch
- 描述：批量删除PrivacyLog实体
