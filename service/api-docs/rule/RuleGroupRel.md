...
| --- | --- |
| 实体类名 | RuleGroupRel |
| 数据库表名 | rule_group_rel |
| 所属模块 | rule |
| API基础路径 | /api/rule/rulegrouprel |
...
**请求信息**
- 方法：GET
- 路径：/api/rule/rulegrouprel/:id
- 描述：根据ID获取单个RuleGroupRel的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/rule/rulegrouprel
- 描述：分页获取RuleGroupRel列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/rule/rulegrouprel/batch
- 描述：批量删除RuleGroupRel实体
