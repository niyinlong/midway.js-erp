...
**请求信息**
- 方法：GET
- 路径：/api/web/webtourtour/:id
- 描述：根据ID获取单个WebTourTour的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/web/webtourtour
- 描述：分页获取WebTourTour列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/web/webtourtour/batch
- 描述：批量删除WebTourTour实体
