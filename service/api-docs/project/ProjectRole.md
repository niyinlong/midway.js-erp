...
| 数据库表名 | project_role |
| 所属模块 | project |
| API基础路径 | /api/project/projectrole |
...
**请求信息**
- 方法：GET
- 路径：/api/project/projectrole/:id
- 描述：根据ID获取单个ProjectRole的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/project/projectrole
- 描述：分页获取ProjectRole列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/project/projectrole/batch
- 描述：批量删除ProjectRole实体
