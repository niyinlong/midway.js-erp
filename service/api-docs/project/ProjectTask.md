...
| 数据库表名 | project_task |
| 所属模块 | project |
| API基础路径 | /api/project/projecttask |
...
**请求信息**
- 方法：GET
- 路径：/api/project/projecttask/:id
- 描述：根据ID获取单个ProjectTask的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/project/projecttask
- 描述：分页获取ProjectTask列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/project/projecttask/batch
- 描述：批量删除ProjectTask实体
