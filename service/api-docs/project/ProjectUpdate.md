...
| --- | --- |
| 实体类名 | ProjectUpdate |
| 数据库表名 | project_update |
| 所属模块 | project |
| API基础路径 | /api/project/projectupdate |
...
**请求信息**
- 方法：GET
- 路径：/api/project/projectupdate/:id
- 描述：根据ID获取单个ProjectUpdate的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/project/projectupdate
- 描述：分页获取ProjectUpdate列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/project/projectupdate/batch
- 描述：批量删除ProjectUpdate实体
