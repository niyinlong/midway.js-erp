...
| 数据库表名 | project_tags |
| 所属模块 | project |
| API基础路径 | /api/project/projecttags |
...
**请求信息**
- 方法：GET
- 路径：/api/project/projecttags/:id
- 描述：根据ID获取单个ProjectTags的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/project/projecttags
- 描述：分页获取ProjectTags列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/project/projecttags/batch
- 描述：批量删除ProjectTags实体
