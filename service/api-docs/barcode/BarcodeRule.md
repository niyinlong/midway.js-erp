...
| 数据库表名 | barcode_rule |
| 所属模块 | barcode |
| API基础路径 | /api/barcode/barcoderule |
...
**请求信息**
- 方法：GET
- 路径：/api/barcode/barcoderule/:id
- 描述：根据ID获取单个BarcodeRule的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/barcode/barcoderule
- 描述：分页获取BarcodeRule列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/barcode/barcoderule/batch
- 描述：批量删除BarcodeRule实体
