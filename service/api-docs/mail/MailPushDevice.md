...
| --- | --- |
| 实体类名 | MailPushDevice |
| 数据库表名 | mail_push_device |
| 所属模块 | mail |
| API基础路径 | /api/mail/mailpushdevice |
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailpushdevice/:id
- 描述：根据ID获取单个MailPushDevice的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailpushdevice
- 描述：分页获取MailPushDevice列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mail/mailpushdevice/batch
- 描述：批量删除MailPushDevice实体
