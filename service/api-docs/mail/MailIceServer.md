...
| --- | --- |
| 实体类名 | MailIceServer |
| 数据库表名 | mail_ice_server |
| 所属模块 | mail |
| API基础路径 | /api/mail/mailiceserver |
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailiceserver/:id
- 描述：根据ID获取单个MailIceServer的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailiceserver
- 描述：分页获取MailIceServer列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mail/mailiceserver/batch
- 描述：批量删除MailIceServer实体
