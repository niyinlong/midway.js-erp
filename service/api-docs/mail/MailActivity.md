...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailactivity/:id
- 描述：根据ID获取单个MailActivity的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailactivity
- 描述：分页获取MailActivity列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mail/mailactivity/batch
- 描述：批量删除MailActivity实体
