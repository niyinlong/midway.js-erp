...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailtemplate/:id
- 描述：根据ID获取单个MailTemplate的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailtemplate
- 描述：分页获取MailTemplate列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mail/mailtemplate/batch
- 描述：批量删除MailTemplate实体
