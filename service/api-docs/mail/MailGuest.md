...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailguest/:id
- 描述：根据ID获取单个MailGuest的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailguest
- 描述：分页获取MailGuest列表，支持关键字搜索和排序
