...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailpresence/:id
- 描述：根据ID获取单个MailPresence的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailpresence
- 描述：分页获取MailPresence列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mail/mailpresence/batch
- 描述：批量删除MailPresence实体
