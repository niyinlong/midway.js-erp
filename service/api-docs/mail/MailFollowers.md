...
| --- | --- |
| 实体类名 | MailFollowers |
| 数据库表名 | mail_followers |
| 所属模块 | mail |
| API基础路径 | /api/mail/mailfollowers |
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailfollowers/:id
- 描述：根据ID获取单个MailFollowers的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailfollowers
- 描述：分页获取MailFollowers列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mail/mailfollowers/batch
- 描述：批量删除MailFollowers实体
