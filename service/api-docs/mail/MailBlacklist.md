...
| --- | --- |
| 实体类名 | MailBlacklist |
| 数据库表名 | mail_blacklist |
| 所属模块 | mail |
| API基础路径 | /api/mail/mailblacklist |
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailblacklist/:id
- 描述：根据ID获取单个MailBlacklist的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailblacklist
- 描述：分页获取MailBlacklist列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mail/mailblacklist/batch
- 描述：批量删除MailBlacklist实体
