...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailmessage/:id
- 描述：根据ID获取单个MailMessage的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mail/mailmessage
- 描述：分页获取MailMessage列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mail/mailmessage/batch
- 描述：批量删除MailMessage实体
