...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpworkorder/:id
- 描述：根据ID获取单个MrpWorkorder的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpworkorder
- 描述：分页获取MrpWorkorder列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mrp/mrpworkorder/batch
- 描述：批量删除MrpWorkorder实体
