...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpbomline/:id
- 描述：根据ID获取单个MrpBomLine的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpbomline
- 描述：分页获取MrpBomLine列表，支持关键字搜索和排序
