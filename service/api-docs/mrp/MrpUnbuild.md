...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpunbuild/:id
- 描述：根据ID获取单个MrpUnbuild的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpunbuild
- 描述：分页获取MrpUnbuild列表，支持关键字搜索和排序
