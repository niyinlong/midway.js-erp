...
| --- | --- |
| 实体类名 | MrpWorkcenter |
| 数据库表名 | mrp_workcenter |
| 所属模块 | mrp |
| API基础路径 | /api/mrp/mrpworkcenter |
...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpworkcenter/:id
- 描述：根据ID获取单个MrpWorkcenter的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpworkcenter
- 描述：分页获取MrpWorkcenter列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mrp/mrpworkcenter/batch
- 描述：批量删除MrpWorkcenter实体
