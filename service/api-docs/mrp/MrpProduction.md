...
| --- | --- |
| 实体类名 | MrpProduction |
| 数据库表名 | mrp_production |
| 所属模块 | mrp |
| API基础路径 | /api/mrp/mrpproduction |
...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpproduction/:id
- 描述：根据ID获取单个MrpProduction的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/mrp/mrpproduction
- 描述：分页获取MrpProduction列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/mrp/mrpproduction/batch
- 描述：批量删除MrpProduction实体
