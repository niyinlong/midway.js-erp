...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmtagrel/:id
- 描述：根据ID获取单个CrmTagRel的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmtagrel
- 描述：分页获取CrmTagRel列表，支持关键字搜索和排序
