...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmleadlost/:id
- 描述：根据ID获取单个CrmLeadLost的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmleadlost
- 描述：分页获取CrmLeadLost列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/crm/crmleadlost/batch
- 描述：批量删除CrmLeadLost实体
