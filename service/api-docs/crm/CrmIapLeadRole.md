...
| --- | --- |
| 实体类名 | CrmIapLeadRole |
| 数据库表名 | crm_iap_lead_role |
| 所属模块 | crm |
| API基础路径 | /api/crm/crmiapleadrole |
...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmiapleadrole/:id
- 描述：根据ID获取单个CrmIapLeadRole的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmiapleadrole
- 描述：分页获取CrmIapLeadRole列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/crm/crmiapleadrole/batch
- 描述：批量删除CrmIapLeadRole实体
