...
| --- | --- |
| 实体类名 | CrmLostReason |
| 数据库表名 | crm_lost_reason |
| 所属模块 | crm |
| API基础路径 | /api/crm/crmlostreason |
...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmlostreason/:id
- 描述：根据ID获取单个CrmLostReason的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmlostreason
- 描述：分页获取CrmLostReason列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/crm/crmlostreason/batch
- 描述：批量删除CrmLostReason实体
