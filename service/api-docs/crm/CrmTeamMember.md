...
| --- | --- |
| 实体类名 | CrmTeamMember |
| 数据库表名 | crm_team_member |
| 所属模块 | crm |
| API基础路径 | /api/crm/crmteammember |
...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmteammember/:id
- 描述：根据ID获取单个CrmTeamMember的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/crm/crmteammember
- 描述：分页获取CrmTeamMember列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/crm/crmteammember/batch
- 描述：批量删除CrmTeamMember实体
