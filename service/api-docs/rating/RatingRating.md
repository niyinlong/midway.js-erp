...
| 数据库表名 | rating_rating |
| 所属模块 | rating |
| API基础路径 | /api/rating/ratingrating |
...
**请求信息**
- 方法：GET
- 路径：/api/rating/ratingrating/:id
- 描述：根据ID获取单个RatingRating的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/rating/ratingrating
- 描述：分页获取RatingRating列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/rating/ratingrating/batch
- 描述：批量删除RatingRating实体
