...
| 数据库表名 | portal_share |
| 所属模块 | portal |
| API基础路径 | /api/portal/portalshare |
...
**请求信息**
- 方法：GET
- 路径：/api/portal/portalshare/:id
- 描述：根据ID获取单个PortalShare的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/portal/portalshare
- 描述：分页获取PortalShare列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/portal/portalshare/batch
- 描述：批量删除PortalShare实体
