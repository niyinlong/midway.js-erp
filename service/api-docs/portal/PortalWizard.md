...
| 数据库表名 | portal_wizard |
| 所属模块 | portal |
| API基础路径 | /api/portal/portalwizard |
...
**请求信息**
- 方法：GET
- 路径：/api/portal/portalwizard/:id
- 描述：根据ID获取单个PortalWizard的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/portal/portalwizard
- 描述：分页获取PortalWizard列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/portal/portalwizard/batch
- 描述：批量删除PortalWizard实体
