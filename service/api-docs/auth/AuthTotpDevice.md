...
| --- | --- |
| 实体类名 | AuthTotpDevice |
| 数据库表名 | auth_totp_device |
| 所属模块 | auth |
| API基础路径 | /api/auth/authtotpdevice |
...
**请求信息**
- 方法：GET
- 路径：/api/auth/authtotpdevice/:id
- 描述：根据ID获取单个AuthTotpDevice的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/auth/authtotpdevice
- 描述：分页获取AuthTotpDevice列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/auth/authtotpdevice/batch
- 描述：批量删除AuthTotpDevice实体
