...
| --- | --- |
| 实体类名 | AuthPasskeyKey |
| 数据库表名 | auth_passkey_key |
| 所属模块 | auth |
| API基础路径 | /api/auth/authpasskeykey |
...
**请求信息**
- 方法：GET
- 路径：/api/auth/authpasskeykey/:id
- 描述：根据ID获取单个AuthPasskeyKey的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/auth/authpasskeykey
- 描述：分页获取AuthPasskeyKey列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/auth/authpasskeykey/batch
- 描述：批量删除AuthPasskeyKey实体
