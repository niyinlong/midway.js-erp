...
| --- | --- |
| 实体类名 | AuthTotpWizard |
| 数据库表名 | auth_totp_wizard |
| 所属模块 | auth |
| API基础路径 | /api/auth/authtotpwizard |
...
**请求信息**
- 方法：GET
- 路径：/api/auth/authtotpwizard/:id
- 描述：根据ID获取单个AuthTotpWizard的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/auth/authtotpwizard
- 描述：分页获取AuthTotpWizard列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/auth/authtotpwizard/batch
- 描述：批量删除AuthTotpWizard实体
