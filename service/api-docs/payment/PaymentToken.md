...
| 数据库表名 | payment_token |
| 所属模块 | payment |
| API基础路径 | /api/payment/paymenttoken |
...
**请求信息**
- 方法：GET
- 路径：/api/payment/paymenttoken/:id
- 描述：根据ID获取单个PaymentToken的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/payment/paymenttoken
- 描述：分页获取PaymentToken列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/payment/paymenttoken/batch
- 描述：批量删除PaymentToken实体
