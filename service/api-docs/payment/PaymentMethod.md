...
| --- | --- |
| 实体类名 | PaymentMethod |
| 数据库表名 | payment_method |
| 所属模块 | payment |
| API基础路径 | /api/payment/paymentmethod |
...
**请求信息**
- 方法：GET
- 路径：/api/payment/paymentmethod/:id
- 描述：根据ID获取单个PaymentMethod的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/payment/paymentmethod
- 描述：分页获取PaymentMethod列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/payment/paymentmethod/batch
- 描述：批量删除PaymentMethod实体
