...
| --- | --- |
| 实体类名 | StockMoveLine |
| 数据库表名 | stock_move_line |
| 所属模块 | stock |
| API基础路径 | /api/stock/stockmoveline |
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockmoveline/:id
- 描述：根据ID获取单个StockMoveLine的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockmoveline
- 描述：分页获取StockMoveLine列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/stock/stockmoveline/batch
- 描述：批量删除StockMoveLine实体
