...
| 数据库表名 | stock_picking |
| 所属模块 | stock |
| API基础路径 | /api/stock/stockpicking |
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockpicking/:id
- 描述：根据ID获取单个StockPicking的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockpicking
- 描述：分页获取StockPicking列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/stock/stockpicking/batch
- 描述：批量删除StockPicking实体
