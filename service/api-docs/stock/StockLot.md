...
**请求信息**
- 方法：GET
- 路径：/api/stock/stocklot/:id
- 描述：根据ID获取单个StockLot的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stocklot
- 描述：分页获取StockLot列表，支持关键字搜索和排序
