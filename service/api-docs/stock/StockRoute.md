...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockroute/:id
- 描述：根据ID获取单个StockRoute的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockroute
- 描述：分页获取StockRoute列表，支持关键字搜索和排序
