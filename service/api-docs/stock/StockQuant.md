...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockquant/:id
- 描述：根据ID获取单个StockQuant的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockquant
- 描述：分页获取StockQuant列表，支持关键字搜索和排序
