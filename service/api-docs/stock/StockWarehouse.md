...
| --- | --- |
| 实体类名 | StockWarehouse |
| 数据库表名 | stock_warehouse |
| 所属模块 | stock |
| API基础路径 | /api/stock/stockwarehouse |
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockwarehouse/:id
- 描述：根据ID获取单个StockWarehouse的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockwarehouse
- 描述：分页获取StockWarehouse列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/stock/stockwarehouse/batch
- 描述：批量删除StockWarehouse实体
