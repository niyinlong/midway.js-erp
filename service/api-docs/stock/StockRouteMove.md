...
| --- | --- |
| 实体类名 | StockRouteMove |
| 数据库表名 | stock_route_move |
| 所属模块 | stock |
| API基础路径 | /api/stock/stockroutemove |
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockroutemove/:id
- 描述：根据ID获取单个StockRouteMove的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockroutemove
- 描述：分页获取StockRouteMove列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/stock/stockroutemove/batch
- 描述：批量删除StockRouteMove实体
