...
| --- | --- |
| 实体类名 | StockReference |
| 数据库表名 | stock_reference |
| 所属模块 | stock |
| API基础路径 | /api/stock/stockreference |
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockreference/:id
- 描述：根据ID获取单个StockReference的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockreference
- 描述：分页获取StockReference列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/stock/stockreference/batch
- 描述：批量删除StockReference实体
