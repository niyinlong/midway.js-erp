...
| --- | --- |
| 实体类名 | StockLocation |
| 数据库表名 | stock_location |
| 所属模块 | stock |
| API基础路径 | /api/stock/stocklocation |
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stocklocation/:id
- 描述：根据ID获取单个StockLocation的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stocklocation
- 描述：分页获取StockLocation列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/stock/stocklocation/batch
- 描述：批量删除StockLocation实体
