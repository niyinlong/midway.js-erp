...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockscrap/:id
- 描述：根据ID获取单个StockScrap的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockscrap
- 描述：分页获取StockScrap列表，支持关键字搜索和排序
