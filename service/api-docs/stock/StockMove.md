...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockmove/:id
- 描述：根据ID获取单个StockMove的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockmove
- 描述：分页获取StockMove列表，支持关键字搜索和排序
