...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockrule/:id
- 描述：根据ID获取单个StockRule的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockrule
- 描述：分页获取StockRule列表，支持关键字搜索和排序
