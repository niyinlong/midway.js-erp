...
| 数据库表名 | stock_package |
| 所属模块 | stock |
| API基础路径 | /api/stock/stockpackage |
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockpackage/:id
- 描述：根据ID获取单个StockPackage的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/stock/stockpackage
- 描述：分页获取StockPackage列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/stock/stockpackage/batch
- 描述：批量删除StockPackage实体
