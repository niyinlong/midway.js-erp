...
| --- | --- |
| 实体类名 | HrSkillLevel |
| 数据库表名 | hr_skill_level |
| 所属模块 | hr |
| API基础路径 | /api/hr/hrskilllevel |
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrskilllevel/:id
- 描述：根据ID获取单个HrSkillLevel的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrskilllevel
- 描述：分页获取HrSkillLevel列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/hr/hrskilllevel/batch
- 描述：批量删除HrSkillLevel实体
