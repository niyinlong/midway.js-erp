...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrjobskill/:id
- 描述：根据ID获取单个HrJobSkill的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrjobskill
- 描述：分页获取HrJobSkill列表，支持关键字搜索和排序
