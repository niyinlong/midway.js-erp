...
| --- | --- |
| 实体类名 | HrContractType |
| 数据库表名 | hr_contract_type |
| 所属模块 | hr |
| API基础路径 | /api/hr/hrcontracttype |
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrcontracttype/:id
- 描述：根据ID获取单个HrContractType的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrcontracttype
- 描述：分页获取HrContractType列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/hr/hrcontracttype/batch
- 描述：批量删除HrContractType实体
