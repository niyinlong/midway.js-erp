...
| --- | --- |
| 实体类名 | HrResumeLine |
| 数据库表名 | hr_resume_line |
| 所属模块 | hr |
| API基础路径 | /api/hr/hrresumeline |
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrresumeline/:id
- 描述：根据ID获取单个HrResumeLine的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrresumeline
- 描述：分页获取HrResumeLine列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/hr/hrresumeline/batch
- 描述：批量删除HrResumeLine实体
