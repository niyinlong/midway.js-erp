...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrdepartment/:id
- 描述：根据ID获取单个HrDepartment的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrdepartment
- 描述：分页获取HrDepartment列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/hr/hrdepartment/batch
- 描述：批量删除HrDepartment实体
