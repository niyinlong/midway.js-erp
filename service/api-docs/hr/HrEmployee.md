...
**请求信息**
- 方法：GET
- 路径：/api/hr/hremployee/:id
- 描述：根据ID获取单个HrEmployee的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hremployee
- 描述：分页获取HrEmployee列表，支持关键字搜索和排序
