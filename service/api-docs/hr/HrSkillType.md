...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrskilltype/:id
- 描述：根据ID获取单个HrSkillType的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrskilltype
- 描述：分页获取HrSkillType列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/hr/hrskilltype/batch
- 描述：批量删除HrSkillType实体
