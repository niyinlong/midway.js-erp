...
| --- | --- |
| 实体类名 | HrWorkLocation |
| 数据库表名 | hr_work_location |
| 所属模块 | hr |
| API基础路径 | /api/hr/hrworklocation |
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrworklocation/:id
- 描述：根据ID获取单个HrWorkLocation的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/hr/hrworklocation
- 描述：分页获取HrWorkLocation列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/hr/hrworklocation/batch
- 描述：批量删除HrWorkLocation实体
