...
**请求信息**
- 方法：GET
- 路径：/api/rel/relslidetag/:id
- 描述：根据ID获取单个RelSlideTag的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/rel/relslidetag
- 描述：分页获取RelSlideTag列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/rel/relslidetag/batch
- 描述：批量删除RelSlideTag实体
