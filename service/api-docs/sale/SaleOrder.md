...
**请求信息**
- 方法：GET
- 路径：/api/sale/saleorder/:id
- 描述：根据ID获取单个SaleOrder的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/sale/saleorder
- 描述：分页获取SaleOrder列表，支持关键字搜索和排序
