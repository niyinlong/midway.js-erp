...
| --- | --- |
| 实体类名 | SaleOrderLine |
| 数据库表名 | sale_order_line |
| 所属模块 | sale |
| API基础路径 | /api/sale/saleorderline |
...
**请求信息**
- 方法：GET
- 路径：/api/sale/saleorderline/:id
- 描述：根据ID获取单个SaleOrderLine的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/sale/saleorderline
- 描述：分页获取SaleOrderLine列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/sale/saleorderline/batch
- 描述：批量删除SaleOrderLine实体
