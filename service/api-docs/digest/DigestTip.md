...
**请求信息**
- 方法：GET
- 路径：/api/digest/digesttip/:id
- 描述：根据ID获取单个DigestTip的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/digest/digesttip
- 描述：分页获取DigestTip列表，支持关键字搜索和排序
