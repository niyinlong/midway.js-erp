...
| 数据库表名 | digest_digest |
| 所属模块 | digest |
| API基础路径 | /api/digest/digestdigest |
...
**请求信息**
- 方法：GET
- 路径：/api/digest/digestdigest/:id
- 描述：根据ID获取单个DigestDigest的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/digest/digestdigest
- 描述：分页获取DigestDigest列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/digest/digestdigest/batch
- 描述：批量删除DigestDigest实体
