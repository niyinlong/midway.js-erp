...
| --- | --- |
| 实体类名 | SlideQuestion |
| 数据库表名 | slide_question |
| 所属模块 | slide |
| API基础路径 | /api/slide/slidequestion |
...
**请求信息**
- 方法：GET
- 路径：/api/slide/slidequestion/:id
- 描述：根据ID获取单个SlideQuestion的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/slide/slidequestion
- 描述：分页获取SlideQuestion列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/slide/slidequestion/batch
- 描述：批量删除SlideQuestion实体
