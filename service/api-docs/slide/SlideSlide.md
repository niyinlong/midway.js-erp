...
**请求信息**
- 方法：GET
- 路径：/api/slide/slideslide/:id
- 描述：根据ID获取单个SlideSlide的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/slide/slideslide
- 描述：分页获取SlideSlide列表，支持关键字搜索和排序
