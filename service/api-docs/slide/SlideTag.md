...
**请求信息**
- 方法：GET
- 路径：/api/slide/slidetag/:id
- 描述：根据ID获取单个SlideTag的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/slide/slidetag
- 描述：分页获取SlideTag列表，支持关键字搜索和排序
