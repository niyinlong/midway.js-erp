...
**请求信息**
- 方法：GET
- 路径：/api/slide/slideanswer/:id
- 描述：根据ID获取单个SlideAnswer的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/slide/slideanswer
- 描述：分页获取SlideAnswer列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/slide/slideanswer/batch
- 描述：批量删除SlideAnswer实体
