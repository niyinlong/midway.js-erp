...
| 数据库表名 | slide_channel |
| 所属模块 | slide |
| API基础路径 | /api/slide/slidechannel |
...
**请求信息**
- 方法：GET
- 路径：/api/slide/slidechannel/:id
- 描述：根据ID获取单个SlideChannel的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/slide/slidechannel
- 描述：分页获取SlideChannel列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/slide/slidechannel/batch
- 描述：批量删除SlideChannel实体
