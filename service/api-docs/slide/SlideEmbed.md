...
**请求信息**
- 方法：GET
- 路径：/api/slide/slideembed/:id
- 描述：根据ID获取单个SlideEmbed的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/slide/slideembed
- 描述：分页获取SlideEmbed列表，支持关键字搜索和排序
