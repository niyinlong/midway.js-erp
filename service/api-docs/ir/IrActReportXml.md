...
| --- | --- |
| 实体类名 | IrActReportXml |
| 数据库表名 | ir_act_report_xml |
| 所属模块 | ir |
| API基础路径 | /api/ir/iractreportxml |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractreportxml/:id
- 描述：根据ID获取单个IrActReportXml的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractreportxml
- 描述：分页获取IrActReportXml列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/iractreportxml/batch
- 描述：批量删除IrActReportXml实体
