...
| --- | --- |
| 实体类名 | IrCronProgress |
| 数据库表名 | ir_cron_progress |
| 所属模块 | ir |
| API基础路径 | /api/ir/ircronprogress |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/ircronprogress/:id
- 描述：根据ID获取单个IrCronProgress的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/ircronprogress
- 描述：分页获取IrCronProgress列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/ircronprogress/batch
- 描述：批量删除IrCronProgress实体
