...
| --- | --- |
| 实体类名 | IrActionsTodo |
| 数据库表名 | ir_actions_todo |
| 所属模块 | ir |
| API基础路径 | /api/ir/iractionstodo |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractionstodo/:id
- 描述：根据ID获取单个IrActionsTodo的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractionstodo
- 描述：分页获取IrActionsTodo列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/iractionstodo/batch
- 描述：批量删除IrActionsTodo实体
