...
| --- | --- |
| 实体类名 | IrModelFields |
| 数据库表名 | ir_model_fields |
| 所属模块 | ir |
| API基础路径 | /api/ir/irmodelfields |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodelfields/:id
- 描述：根据ID获取单个IrModelFields的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodelfields
- 描述：分页获取IrModelFields列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irmodelfields/batch
- 描述：批量删除IrModelFields实体
