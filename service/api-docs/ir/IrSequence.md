...
**请求信息**
- 方法：GET
- 路径：/api/ir/irsequence/:id
- 描述：根据ID获取单个IrSequence的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irsequence
- 描述：分页获取IrSequence列表，支持关键字搜索和排序
