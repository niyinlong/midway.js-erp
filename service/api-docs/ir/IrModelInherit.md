...
| --- | --- |
| 实体类名 | IrModelInherit |
| 数据库表名 | ir_model_inherit |
| 所属模块 | ir |
| API基础路径 | /api/ir/irmodelinherit |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodelinherit/:id
- 描述：根据ID获取单个IrModelInherit的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodelinherit
- 描述：分页获取IrModelInherit列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irmodelinherit/batch
- 描述：批量删除IrModelInherit实体
