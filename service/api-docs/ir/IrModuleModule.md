...
| --- | --- |
| 实体类名 | IrModuleModule |
| 数据库表名 | ir_module_module |
| 所属模块 | ir |
| API基础路径 | /api/ir/irmodulemodule |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodulemodule/:id
- 描述：根据ID获取单个IrModuleModule的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodulemodule
- 描述：分页获取IrModuleModule列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irmodulemodule/batch
- 描述：批量删除IrModuleModule实体
