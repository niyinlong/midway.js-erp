...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodeldata/:id
- 描述：根据ID获取单个IrModelData的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodeldata
- 描述：分页获取IrModelData列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irmodeldata/batch
- 描述：批量删除IrModelData实体
