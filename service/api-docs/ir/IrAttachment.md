...
**请求信息**
- 方法：GET
- 路径：/api/ir/irattachment/:id
- 描述：根据ID获取单个IrAttachment的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irattachment
- 描述：分页获取IrAttachment列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irattachment/batch
- 描述：批量删除IrAttachment实体
