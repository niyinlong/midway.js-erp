...
| --- | --- |
| 实体类名 | IrUiViewCustom |
| 数据库表名 | ir_ui_view_custom |
| 所属模块 | ir |
| API基础路径 | /api/ir/iruiviewcustom |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iruiviewcustom/:id
- 描述：根据ID获取单个IrUiViewCustom的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iruiviewcustom
- 描述：分页获取IrUiViewCustom列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/iruiviewcustom/batch
- 描述：批量删除IrUiViewCustom实体
