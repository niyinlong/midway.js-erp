...
| --- | --- |
| 实体类名 | IrExportsLine |
| 数据库表名 | ir_exports_line |
| 所属模块 | ir |
| API基础路径 | /api/ir/irexportsline |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irexportsline/:id
- 描述：根据ID获取单个IrExportsLine的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irexportsline
- 描述：分页获取IrExportsLine列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irexportsline/batch
- 描述：批量删除IrExportsLine实体
