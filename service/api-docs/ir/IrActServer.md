...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractserver/:id
- 描述：根据ID获取单个IrActServer的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractserver
- 描述：分页获取IrActServer列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/iractserver/batch
- 描述：批量删除IrActServer实体
