...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractwindow/:id
- 描述：根据ID获取单个IrActWindow的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractwindow
- 描述：分页获取IrActWindow列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/iractwindow/batch
- 描述：批量删除IrActWindow实体
