...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractclient/:id
- 描述：根据ID获取单个IrActClient的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/iractclient
- 描述：分页获取IrActClient列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/iractclient/batch
- 描述：批量删除IrActClient实体
