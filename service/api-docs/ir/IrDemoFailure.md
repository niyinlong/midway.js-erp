...
| --- | --- |
| 实体类名 | IrDemoFailure |
| 数据库表名 | ir_demo_failure |
| 所属模块 | ir |
| API基础路径 | /api/ir/irdemofailure |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irdemofailure/:id
- 描述：根据ID获取单个IrDemoFailure的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irdemofailure
- 描述：分页获取IrDemoFailure列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irdemofailure/batch
- 描述：批量删除IrDemoFailure实体
