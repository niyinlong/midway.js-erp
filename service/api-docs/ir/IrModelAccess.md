...
| --- | --- |
| 实体类名 | IrModelAccess |
| 数据库表名 | ir_model_access |
| 所属模块 | ir |
| API基础路径 | /api/ir/irmodelaccess |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodelaccess/:id
- 描述：根据ID获取单个IrModelAccess的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmodelaccess
- 描述：分页获取IrModelAccess列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irmodelaccess/batch
- 描述：批量删除IrModelAccess实体
