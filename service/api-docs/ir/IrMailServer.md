...
| --- | --- |
| 实体类名 | IrMailServer |
| 数据库表名 | ir_mail_server |
| 所属模块 | ir |
| API基础路径 | /api/ir/irmailserver |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmailserver/:id
- 描述：根据ID获取单个IrMailServer的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/irmailserver
- 描述：分页获取IrMailServer列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/irmailserver/batch
- 描述：批量删除IrMailServer实体
