...
| --- | --- |
| 实体类名 | IrCronTrigger |
| 数据库表名 | ir_cron_trigger |
| 所属模块 | ir |
| API基础路径 | /api/ir/ircrontrigger |
...
**请求信息**
- 方法：GET
- 路径：/api/ir/ircrontrigger/:id
- 描述：根据ID获取单个IrCronTrigger的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/ir/ircrontrigger
- 描述：分页获取IrCronTrigger列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/ir/ircrontrigger/batch
- 描述：批量删除IrCronTrigger实体
