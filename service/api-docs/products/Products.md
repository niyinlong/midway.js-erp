...
**请求信息**
- 方法：GET
- 路径：/api/products/products/:id
- 描述：根据ID获取单个Products的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/products/products
- 描述：分页获取Products列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/products/products/batch
- 描述：批量删除Products实体
