...
| --- | --- |
| 实体类名 | ThemeIrAsset |
| 数据库表名 | theme_ir_asset |
| 所属模块 | theme |
| API基础路径 | /api/theme/themeirasset |
...
**请求信息**
- 方法：GET
- 路径：/api/theme/themeirasset/:id
- 描述：根据ID获取单个ThemeIrAsset的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/theme/themeirasset
- 描述：分页获取ThemeIrAsset列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/theme/themeirasset/batch
- 描述：批量删除ThemeIrAsset实体
