...
| --- | --- |
| 实体类名 | ThemeIrUiView |
| 数据库表名 | theme_ir_ui_view |
| 所属模块 | theme |
| API基础路径 | /api/theme/themeiruiview |
...
**请求信息**
- 方法：GET
- 路径：/api/theme/themeiruiview/:id
- 描述：根据ID获取单个ThemeIrUiView的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/theme/themeiruiview
- 描述：分页获取ThemeIrUiView列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/theme/themeiruiview/batch
- 描述：批量删除ThemeIrUiView实体
