...
**请求信息**
- 方法：GET
- 路径：/api/sms/smscomposer/:id
- 描述：根据ID获取单个SmsComposer的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/sms/smscomposer
- 描述：分页获取SmsComposer列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/sms/smscomposer/batch
- 描述：批量删除SmsComposer实体
