...
| --- | --- |
| 实体类名 | SmsAccountCode |
| 数据库表名 | sms_account_code |
| 所属模块 | sms |
| API基础路径 | /api/sms/smsaccountcode |
...
**请求信息**
- 方法：GET
- 路径：/api/sms/smsaccountcode/:id
- 描述：根据ID获取单个SmsAccountCode的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/sms/smsaccountcode
- 描述：分页获取SmsAccountCode列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/sms/smsaccountcode/batch
- 描述：批量删除SmsAccountCode实体
