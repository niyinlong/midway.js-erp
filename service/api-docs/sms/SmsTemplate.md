...
**请求信息**
- 方法：GET
- 路径：/api/sms/smstemplate/:id
- 描述：根据ID获取单个SmsTemplate的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/sms/smstemplate
- 描述：分页获取SmsTemplate列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/sms/smstemplate/batch
- 描述：批量删除SmsTemplate实体
