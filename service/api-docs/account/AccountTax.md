...
| 数据库表名 | account_tax |
| 所属模块 | account |
| API基础路径 | /api/account/accounttax |
...
**请求信息**
- 方法：GET
- 路径：/api/account/accounttax/:id
- 描述：根据ID获取单个AccountTax的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/account/accounttax
- 描述：分页获取AccountTax列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/account/accounttax/batch
- 描述：批量删除AccountTax实体
