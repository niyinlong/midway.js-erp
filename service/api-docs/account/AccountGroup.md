...
| 数据库表名 | account_group |
| 所属模块 | account |
| API基础路径 | /api/account/accountgroup |
...
**请求信息**
- 方法：GET
- 路径：/api/account/accountgroup/:id
- 描述：根据ID获取单个AccountGroup的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/account/accountgroup
- 描述：分页获取AccountGroup列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/account/accountgroup/batch
- 描述：批量删除AccountGroup实体
