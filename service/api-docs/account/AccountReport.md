...
| --- | --- |
| 实体类名 | AccountReport |
| 数据库表名 | account_report |
| 所属模块 | account |
| API基础路径 | /api/account/accountreport |
...
**请求信息**
- 方法：GET
- 路径：/api/account/accountreport/:id
- 描述：根据ID获取单个AccountReport的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/account/accountreport
- 描述：分页获取AccountReport列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/account/accountreport/batch
- 描述：批量删除AccountReport实体
