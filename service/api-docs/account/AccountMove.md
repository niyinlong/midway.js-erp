...
| 数据库表名 | account_move |
| 所属模块 | account |
| API基础路径 | /api/account/accountmove |
...
**请求信息**
- 方法：GET
- 路径：/api/account/accountmove/:id
- 描述：根据ID获取单个AccountMove的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/account/accountmove
- 描述：分页获取AccountMove列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/account/accountmove/batch
- 描述：批量删除AccountMove实体
