...
| --- | --- |
| 实体类名 | PurchaseOrder |
| 数据库表名 | purchase_order |
| 所属模块 | purchase |
| API基础路径 | /api/purchase/purchaseorder |
...
**请求信息**
- 方法：GET
- 路径：/api/purchase/purchaseorder/:id
- 描述：根据ID获取单个PurchaseOrder的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/purchase/purchaseorder
- 描述：分页获取PurchaseOrder列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/purchase/purchaseorder/batch
- 描述：批量删除PurchaseOrder实体
