...
| --- | --- |
| 实体类名 | LotLabelLayout |
| 数据库表名 | lot_label_layout |
| 所属模块 | lot |
| API基础路径 | /api/lot/lotlabellayout |
...
**请求信息**
- 方法：GET
- 路径：/api/lot/lotlabellayout/:id
- 描述：根据ID获取单个LotLabelLayout的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/lot/lotlabellayout
- 描述：分页获取LotLabelLayout列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/lot/lotlabellayout/batch
- 描述：批量删除LotLabelLayout实体
