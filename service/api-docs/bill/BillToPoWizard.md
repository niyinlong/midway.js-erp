...
| --- | --- |
| 实体类名 | BillToPoWizard |
| 数据库表名 | bill_to_po_wizard |
| 所属模块 | bill |
| API基础路径 | /api/bill/billtopowizard |
...
**请求信息**
- 方法：GET
- 路径：/api/bill/billtopowizard/:id
- 描述：根据ID获取单个BillToPoWizard的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/bill/billtopowizard
- 描述：分页获取BillToPoWizard列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/bill/billtopowizard/batch
- 描述：批量删除BillToPoWizard实体
