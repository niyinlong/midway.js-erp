...
| --- | --- |
| 实体类名 | CalendarAlarm |
| 数据库表名 | calendar_alarm |
| 所属模块 | calendar |
| API基础路径 | /api/calendar/calendaralarm |
...
**请求信息**
- 方法：GET
- 路径：/api/calendar/calendaralarm/:id
- 描述：根据ID获取单个CalendarAlarm的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/calendar/calendaralarm
- 描述：分页获取CalendarAlarm列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/calendar/calendaralarm/batch
- 描述：批量删除CalendarAlarm实体
