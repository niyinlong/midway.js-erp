...
| --- | --- |
| 实体类名 | CalendarEvent |
| 数据库表名 | calendar_event |
| 所属模块 | calendar |
| API基础路径 | /api/calendar/calendarevent |
...
**请求信息**
- 方法：GET
- 路径：/api/calendar/calendarevent/:id
- 描述：根据ID获取单个CalendarEvent的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/calendar/calendarevent
- 描述：分页获取CalendarEvent列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/calendar/calendarevent/batch
- 描述：批量删除CalendarEvent实体
