...
| --- | --- |
| 实体类名 | ModuleCountry |
| 数据库表名 | module_country |
| 所属模块 | module |
| API基础路径 | /api/module/modulecountry |
...
**请求信息**
- 方法：GET
- 路径：/api/module/modulecountry/:id
- 描述：根据ID获取单个ModuleCountry的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/module/modulecountry
- 描述：分页获取ModuleCountry列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/module/modulecountry/batch
- 描述：批量删除ModuleCountry实体
