...
**请求信息**
- 方法：GET
- 路径：/api/utm/utmtagrel/:id
- 描述：根据ID获取单个UtmTagRel的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/utm/utmtagrel
- 描述：分页获取UtmTagRel列表，支持关键字搜索和排序
