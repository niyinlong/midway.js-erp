...
**请求信息**
- 方法：GET
- 路径：/api/utm/utmcampaign/:id
- 描述：根据ID获取单个UtmCampaign的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/utm/utmcampaign
- 描述：分页获取UtmCampaign列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/utm/utmcampaign/batch
- 描述：批量删除UtmCampaign实体
