...
**请求信息**
- 方法：GET
- 路径：/api/utm/utmmedium/:id
- 描述：根据ID获取单个UtmMedium的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/utm/utmmedium
- 描述：分页获取UtmMedium列表，支持关键字搜索和排序
