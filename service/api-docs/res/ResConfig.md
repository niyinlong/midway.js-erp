...
**请求信息**
- 方法：GET
- 路径：/api/res/resconfig/:id
- 描述：根据ID获取单个ResConfig的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/resconfig
- 描述：分页获取ResConfig列表，支持关键字搜索和排序
