...
| --- | --- |
| 实体类名 | ResDeviceLog |
| 数据库表名 | res_device_log |
| 所属模块 | res |
| API基础路径 | /api/res/resdevicelog |
...
**请求信息**
- 方法：GET
- 路径：/api/res/resdevicelog/:id
- 描述：根据ID获取单个ResDeviceLog的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/resdevicelog
- 描述：分页获取ResDeviceLog列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/res/resdevicelog/batch
- 描述：批量删除ResDeviceLog实体
