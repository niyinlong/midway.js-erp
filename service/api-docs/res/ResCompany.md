...
**请求信息**
- 方法：GET
- 路径：/api/res/rescompany/:id
- 描述：根据ID获取单个ResCompany的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/rescompany
- 描述：分页获取ResCompany列表，支持关键字搜索和排序
