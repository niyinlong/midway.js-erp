...
**请求信息**
- 方法：GET
- 路径：/api/res/rescurrency/:id
- 描述：根据ID获取单个ResCurrency的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/rescurrency
- 描述：分页获取ResCurrency列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/res/rescurrency/batch
- 描述：批量删除ResCurrency实体
