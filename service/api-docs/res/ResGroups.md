...
**请求信息**
- 方法：GET
- 路径：/api/res/resgroups/:id
- 描述：根据ID获取单个ResGroups的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/resgroups
- 描述：分页获取ResGroups列表，支持关键字搜索和排序
