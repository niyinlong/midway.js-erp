...
**请求信息**
- 方法：GET
- 路径：/api/res/resuserslog/:id
- 描述：根据ID获取单个ResUsersLog的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/resuserslog
- 描述：分页获取ResUsersLog列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/res/resuserslog/batch
- 描述：批量删除ResUsersLog实体
