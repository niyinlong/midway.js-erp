...
**请求信息**
- 方法：GET
- 路径：/api/res/respartner/:id
- 描述：根据ID获取单个ResPartner的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/respartner
- 描述：分页获取ResPartner列表，支持关键字搜索和排序
