...
| --- | --- |
| 实体类名 | ResPartnerBank |
| 数据库表名 | res_partner_bank |
| 所属模块 | res |
| API基础路径 | /api/res/respartnerbank |
...
**请求信息**
- 方法：GET
- 路径：/api/res/respartnerbank/:id
- 描述：根据ID获取单个ResPartnerBank的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/respartnerbank
- 描述：分页获取ResPartnerBank列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/res/respartnerbank/batch
- 描述：批量删除ResPartnerBank实体
