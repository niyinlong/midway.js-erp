...
**请求信息**
- 方法：GET
- 路径：/api/res/rescountry/:id
- 描述：根据ID获取单个ResCountry的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/res/rescountry
- 描述：分页获取ResCountry列表，支持关键字搜索和排序
