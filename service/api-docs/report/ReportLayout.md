...
| 数据库表名 | report_layout |
| 所属模块 | report |
| API基础路径 | /api/report/reportlayout |
...
**请求信息**
- 方法：GET
- 路径：/api/report/reportlayout/:id
- 描述：根据ID获取单个ReportLayout的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/report/reportlayout
- 描述：分页获取ReportLayout列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/report/reportlayout/batch
- 描述：批量删除ReportLayout实体
