...
**请求信息**
- 方法：GET
- 路径：/api/iap/iapaccount/:id
- 描述：根据ID获取单个IapAccount的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/iap/iapaccount
- 描述：分页获取IapAccount列表，支持关键字搜索和排序
