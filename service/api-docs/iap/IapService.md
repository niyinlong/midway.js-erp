...
**请求信息**
- 方法：GET
- 路径：/api/iap/iapservice/:id
- 描述：根据ID获取单个IapService的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/iap/iapservice
- 描述：分页获取IapService列表，支持关键字搜索和排序
