...
| --- | --- |
| 实体类名 | PhoneBlacklist |
| 数据库表名 | phone_blacklist |
| 所属模块 | phone |
| API基础路径 | /api/phone/phoneblacklist |
...
**请求信息**
- 方法：GET
- 路径：/api/phone/phoneblacklist/:id
- 描述：根据ID获取单个PhoneBlacklist的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/phone/phoneblacklist
- 描述：分页获取PhoneBlacklist列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/phone/phoneblacklist/batch
- 描述：批量删除PhoneBlacklist实体
