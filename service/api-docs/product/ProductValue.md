...
| 数据库表名 | product_value |
| 所属模块 | product |
| API基础路径 | /api/product/productvalue |
...
**请求信息**
- 方法：GET
- 路径：/api/product/productvalue/:id
- 描述：根据ID获取单个ProductValue的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/product/productvalue
- 描述：分页获取ProductValue列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/product/productvalue/batch
- 描述：批量删除ProductValue实体
