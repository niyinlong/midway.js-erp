...
| 数据库表名 | product_combo |
| 所属模块 | product |
| API基础路径 | /api/product/productcombo |
...
**请求信息**
- 方法：GET
- 路径：/api/product/productcombo/:id
- 描述：根据ID获取单个ProductCombo的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/product/productcombo
- 描述：分页获取ProductCombo列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/product/productcombo/batch
- 描述：批量删除ProductCombo实体
