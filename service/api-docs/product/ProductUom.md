...
| 数据库表名 | product_uom |
| 所属模块 | product |
| API基础路径 | /api/product/productuom |
...
**请求信息**
- 方法：GET
- 路径：/api/product/productuom/:id
- 描述：根据ID获取单个ProductUom的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/product/productuom
- 描述：分页获取ProductUom列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/product/productuom/batch
- 描述：批量删除ProductUom实体
