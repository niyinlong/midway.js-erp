...
| 数据库表名 | product_tag |
| 所属模块 | product |
| API基础路径 | /api/product/producttag |
...
**请求信息**
- 方法：GET
- 路径：/api/product/producttag/:id
- 描述：根据ID获取单个ProductTag的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/product/producttag
- 描述：分页获取ProductTag列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/product/producttag/batch
- 描述：批量删除ProductTag实体
