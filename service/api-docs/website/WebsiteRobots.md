...
| --- | --- |
| 实体类名 | WebsiteRobots |
| 数据库表名 | website_robots |
| 所属模块 | website |
| API基础路径 | /api/website/websiterobots |
...
**请求信息**
- 方法：GET
- 路径：/api/website/websiterobots/:id
- 描述：根据ID获取单个WebsiteRobots的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/website/websiterobots
- 描述：分页获取WebsiteRobots列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/website/websiterobots/batch
- 描述：批量删除WebsiteRobots实体
