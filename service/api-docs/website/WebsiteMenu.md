...
| 数据库表名 | website_menu |
| 所属模块 | website |
| API基础路径 | /api/website/websitemenu |
...
**请求信息**
- 方法：GET
- 路径：/api/website/websitemenu/:id
- 描述：根据ID获取单个WebsiteMenu的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/website/websitemenu
- 描述：分页获取WebsiteMenu列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/website/websitemenu/batch
- 描述：批量删除WebsiteMenu实体
