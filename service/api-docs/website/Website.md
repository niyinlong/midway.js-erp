...
**请求信息**
- 方法：GET
- 路径：/api/website/website/:id
- 描述：根据ID获取单个Website的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/website/website
- 描述：分页获取Website列表，支持关键字搜索和排序
