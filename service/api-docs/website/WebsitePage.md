...
| 数据库表名 | website_page |
| 所属模块 | website |
| API基础路径 | /api/website/websitepage |
...
**请求信息**
- 方法：GET
- 路径：/api/website/websitepage/:id
- 描述：根据ID获取单个WebsitePage的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/website/websitepage
- 描述：分页获取WebsitePage列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/website/websitepage/batch
- 描述：批量删除WebsitePage实体
