...
| 数据库表名 | website_route |
| 所属模块 | website |
| API基础路径 | /api/website/websiteroute |
...
**请求信息**
- 方法：GET
- 路径：/api/website/websiteroute/:id
- 描述：根据ID获取单个WebsiteRoute的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/website/websiteroute
- 描述：分页获取WebsiteRoute列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/website/websiteroute/batch
- 描述：批量删除WebsiteRoute实体
