...
| 数据库表名 | website_track |
| 所属模块 | website |
| API基础路径 | /api/website/websitetrack |
...
**请求信息**
- 方法：GET
- 路径：/api/website/websitetrack/:id
- 描述：根据ID获取单个WebsiteTrack的详细信息
...
**请求信息**
- 方法：GET
- 路径：/api/website/websitetrack
- 描述：分页获取WebsiteTrack列表，支持关键字搜索和排序
...
**请求信息**
- 方法：DELETE
- 路径：/api/website/websitetrack/batch
- 描述：批量删除WebsiteTrack实体
