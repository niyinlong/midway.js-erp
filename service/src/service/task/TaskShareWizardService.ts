...
/**
 * TaskShareWizard 服务类
 * 处理 task_share_wizard 表的数据库操作
 */
@Provide()
export class TaskShareWizardService extends BaseService<TaskShareWizard> {
  constructor(
    @InjectRepository(TaskShareWizard)
    repository: Repository<TaskShareWizard>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询TaskShareWizard
   * 可以在此添加业务相关的查询方法
   */
