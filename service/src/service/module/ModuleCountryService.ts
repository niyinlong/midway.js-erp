...
/**
 * ModuleCountry 服务类
 * 处理 module_country 表的数据库操作
 */
@Provide()
export class ModuleCountryService extends BaseService<ModuleCountry> {
  constructor(
    @InjectRepository(ModuleCountry)
    repository: Repository<ModuleCountry>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询ModuleCountry
   * 可以在此添加业务相关的查询方法
   */
