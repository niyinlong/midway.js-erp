...
/**
 * CalendarAlarm 服务类
 * 处理 calendar_alarm 表的数据库操作
 */
@Provide()
export class CalendarAlarmService extends BaseService<CalendarAlarm> {
  constructor(
    @InjectRepository(CalendarAlarm)
    repository: Repository<CalendarAlarm>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询CalendarAlarm
   * 可以在此添加业务相关的查询方法
   */
