...
/**
 * MrpWorkorder 服务类
 * 处理 mrp_workorder 表的数据库操作
 */
@Provide()
export class MrpWorkorderService extends BaseService<MrpWorkorder> {
  constructor(
    @InjectRepository(MrpWorkorder)
    repository: Repository<MrpWorkorder>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询MrpWorkorder
   * 可以在此添加业务相关的查询方法
   */
