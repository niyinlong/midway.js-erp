...
/**
 * MrpProduction 服务类
 * 处理 mrp_production 表的数据库操作
 */
@Provide()
export class MrpProductionService extends BaseService<MrpProduction> {
  constructor(
    @InjectRepository(MrpProduction)
    repository: Repository<MrpProduction>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询MrpProduction
   * 可以在此添加业务相关的查询方法
   */
