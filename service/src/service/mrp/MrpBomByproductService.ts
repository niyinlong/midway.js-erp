...
/**
 * MrpBomByproduct 服务类
 * 处理 mrp_bom_byproduct 表的数据库操作
 */
@Provide()
export class MrpBomByproductService extends BaseService<MrpBomByproduct> {
  constructor(
    @InjectRepository(MrpBomByproduct)
    repository: Repository<MrpBomByproduct>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询MrpBomByproduct
   * 可以在此添加业务相关的查询方法
   */
