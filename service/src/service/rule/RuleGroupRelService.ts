...
/**
 * RuleGroupRel 服务类
 * 处理 rule_group_rel 表的数据库操作
 */
@Provide()
export class RuleGroupRelService extends BaseService<RuleGroupRel> {
  constructor(
    @InjectRepository(RuleGroupRel)
    repository: Repository<RuleGroupRel>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询RuleGroupRel
   * 可以在此添加业务相关的查询方法
   */
