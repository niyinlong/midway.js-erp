...
/**
 * HrJobHrSkillRel 服务类
 * 处理 hr_job_hr_skill_rel 表的数据库操作
 */
@Provide()
export class HrJobHrSkillRelService extends BaseService<HrJobHrSkillRel> {
  constructor(
    @InjectRepository(HrJobHrSkillRel)
    repository: Repository<HrJobHrSkillRel>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询HrJobHrSkillRel
   * 可以在此添加业务相关的查询方法
   */
