...
/**
 * HrSkillType 服务类
 * 处理 hr_skill_type 表的数据库操作
 */
@Provide()
export class HrSkillTypeService extends BaseService<HrSkillType> {
  constructor(
    @InjectRepository(HrSkillType)
    repository: Repository<HrSkillType>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询HrSkillType
   * 可以在此添加业务相关的查询方法
   */
