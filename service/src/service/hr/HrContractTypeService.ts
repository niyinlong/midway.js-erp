...
/**
 * HrContractType 服务类
 * 处理 hr_contract_type 表的数据库操作
 */
@Provide()
export class HrContractTypeService extends BaseService<HrContractType> {
  constructor(
    @InjectRepository(HrContractType)
    repository: Repository<HrContractType>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询HrContractType
   * 可以在此添加业务相关的查询方法
   */
