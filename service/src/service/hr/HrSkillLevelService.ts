...
/**
 * HrSkillLevel 服务类
 * 处理 hr_skill_level 表的数据库操作
 */
@Provide()
export class HrSkillLevelService extends BaseService<HrSkillLevel> {
  constructor(
    @InjectRepository(HrSkillLevel)
    repository: Repository<HrSkillLevel>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询HrSkillLevel
   * 可以在此添加业务相关的查询方法
   */
