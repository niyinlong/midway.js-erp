...
/**
 * HrVersionWizard 服务类
 * 处理 hr_version_wizard 表的数据库操作
 */
@Provide()
export class HrVersionWizardService extends BaseService<HrVersionWizard> {
  constructor(
    @InjectRepository(HrVersionWizard)
    repository: Repository<HrVersionWizard>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询HrVersionWizard
   * 可以在此添加业务相关的查询方法
   */
