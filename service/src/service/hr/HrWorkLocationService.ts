...
/**
 * HrWorkLocation 服务类
 * 处理 hr_work_location 表的数据库操作
 */
@Provide()
export class HrWorkLocationService extends BaseService<HrWorkLocation> {
  constructor(
    @InjectRepository(HrWorkLocation)
    repository: Repository<HrWorkLocation>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询HrWorkLocation
   * 可以在此添加业务相关的查询方法
   */
