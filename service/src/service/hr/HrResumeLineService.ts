...
/**
 * HrResumeLine 服务类
 * 处理 hr_resume_line 表的数据库操作
 */
@Provide()
export class HrResumeLineService extends BaseService<HrResumeLine> {
  constructor(
    @InjectRepository(HrResumeLine)
    repository: Repository<HrResumeLine>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询HrResumeLine
   * 可以在此添加业务相关的查询方法
   */
