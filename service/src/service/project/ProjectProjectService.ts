...
/**
 * ProjectProject 服务类
 * 处理 project_project 表的数据库操作
 */
@Provide()
export class ProjectProjectService extends BaseService<ProjectProject> {
  constructor(
    @InjectRepository(ProjectProject)
    repository: Repository<ProjectProject>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询ProjectProject
   * 可以在此添加业务相关的查询方法
   */
