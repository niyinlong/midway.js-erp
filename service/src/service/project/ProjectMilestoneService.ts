...
/**
 * ProjectMilestone 服务类
 * 处理 project_milestone 表的数据库操作
 */
@Provide()
export class ProjectMilestoneService extends BaseService<ProjectMilestone> {
  constructor(
    @InjectRepository(ProjectMilestone)
    repository: Repository<ProjectMilestone>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询ProjectMilestone
   * 可以在此添加业务相关的查询方法
   */
