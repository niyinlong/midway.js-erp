...
/**
 * PortalShare 服务类
 * 处理 portal_share 表的数据库操作
 */
@Provide()
export class PortalShareService extends BaseService<PortalShare> {
  constructor(
    @InjectRepository(PortalShare)
    repository: Repository<PortalShare>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询PortalShare
   * 可以在此添加业务相关的查询方法
   */
