...
/**
 * PortalWizard 服务类
 * 处理 portal_wizard 表的数据库操作
 */
@Provide()
export class PortalWizardService extends BaseService<PortalWizard> {
  constructor(
    @InjectRepository(PortalWizard)
    repository: Repository<PortalWizard>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询PortalWizard
   * 可以在此添加业务相关的查询方法
   */
