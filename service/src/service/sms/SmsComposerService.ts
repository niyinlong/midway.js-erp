...
/**
 * SmsComposer 服务类
 * 处理 sms_composer 表的数据库操作
 */
@Provide()
export class SmsComposerService extends BaseService<SmsComposer> {
  constructor(
    @InjectRepository(SmsComposer)
    repository: Repository<SmsComposer>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询SmsComposer
   * 可以在此添加业务相关的查询方法
   */
