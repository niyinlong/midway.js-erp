...
/**
 * SmsAccountCode 服务类
 * 处理 sms_account_code 表的数据库操作
 */
@Provide()
export class SmsAccountCodeService extends BaseService<SmsAccountCode> {
  constructor(
    @InjectRepository(SmsAccountCode)
    repository: Repository<SmsAccountCode>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询SmsAccountCode
   * 可以在此添加业务相关的查询方法
   */
