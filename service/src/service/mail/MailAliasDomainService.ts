...
/**
 * MailAliasDomain 服务类
 * 处理 mail_alias_domain 表的数据库操作
 */
@Provide()
export class MailAliasDomainService extends BaseService<MailAliasDomain> {
  constructor(
    @InjectRepository(MailAliasDomain)
    repository: Repository<MailAliasDomain>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询MailAliasDomain
   * 可以在此添加业务相关的查询方法
   */
