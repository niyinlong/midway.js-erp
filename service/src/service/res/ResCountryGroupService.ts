...
/**
 * ResCountryGroup 服务类
 * 处理 res_country_group 表的数据库操作
 */
@Provide()
export class ResCountryGroupService extends BaseService<ResCountryGroup> {
  constructor(
    @InjectRepository(ResCountryGroup)
    repository: Repository<ResCountryGroup>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询ResCountryGroup
   * 可以在此添加业务相关的查询方法
   */
