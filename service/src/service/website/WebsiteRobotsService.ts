...
/**
 * WebsiteRobots 服务类
 * 处理 website_robots 表的数据库操作
 */
@Provide()
export class WebsiteRobotsService extends BaseService<WebsiteRobots> {
  constructor(
    @InjectRepository(WebsiteRobots)
    repository: Repository<WebsiteRobots>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询WebsiteRobots
   * 可以在此添加业务相关的查询方法
   */
