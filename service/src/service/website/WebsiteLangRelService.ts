...
/**
 * WebsiteLangRel 服务类
 * 处理 website_lang_rel 表的数据库操作
 */
@Provide()
export class WebsiteLangRelService extends BaseService<WebsiteLangRel> {
  constructor(
    @InjectRepository(WebsiteLangRel)
    repository: Repository<WebsiteLangRel>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询WebsiteLangRel
   * 可以在此添加业务相关的查询方法
   */
