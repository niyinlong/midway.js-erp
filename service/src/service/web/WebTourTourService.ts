...
/**
 * WebTourTour 服务类
 * 处理 web_tour_tour 表的数据库操作
 */
@Provide()
export class WebTourTourService extends BaseService<WebTourTour> {
  constructor(
    @InjectRepository(WebTourTour)
    repository: Repository<WebTourTour>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询WebTourTour
   * 可以在此添加业务相关的查询方法
   */
