...
/**
 * UtmCampaign 服务类
 * 处理 utm_campaign 表的数据库操作
 */
@Provide()
export class UtmCampaignService extends BaseService<UtmCampaign> {
  constructor(
    @InjectRepository(UtmCampaign)
    repository: Repository<UtmCampaign>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询UtmCampaign
   * 可以在此添加业务相关的查询方法
   */
