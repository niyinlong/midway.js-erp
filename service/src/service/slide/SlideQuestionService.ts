...
/**
 * SlideQuestion 服务类
 * 处理 slide_question 表的数据库操作
 */
@Provide()
export class SlideQuestionService extends BaseService<SlideQuestion> {
  constructor(
    @InjectRepository(SlideQuestion)
    repository: Repository<SlideQuestion>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询SlideQuestion
   * 可以在此添加业务相关的查询方法
   */
