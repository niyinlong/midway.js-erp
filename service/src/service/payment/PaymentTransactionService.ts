...
/**
 * PaymentTransaction 服务类
 * 处理 payment_transaction 表的数据库操作
 */
@Provide()
export class PaymentTransactionService extends BaseService<PaymentTransaction> {
  constructor(
