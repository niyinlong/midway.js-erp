...
/**
 * ThemeIrUiView 服务类
 * 处理 theme_ir_ui_view 表的数据库操作
 */
@Provide()
export class ThemeIrUiViewService extends BaseService<ThemeIrUiView> {
  constructor(
    @InjectRepository(ThemeIrUiView)
    repository: Repository<ThemeIrUiView>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询ThemeIrUiView
   * 可以在此添加业务相关的查询方法
   */
