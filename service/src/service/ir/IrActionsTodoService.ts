...
/**
 * IrActionsTodo 服务类
 * 处理 ir_actions_todo 表的数据库操作
 */
@Provide()
export class IrActionsTodoService extends BaseService<IrActionsTodo> {
  constructor(
    @InjectRepository(IrActionsTodo)
    repository: Repository<IrActionsTodo>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询IrActionsTodo
   * 可以在此添加业务相关的查询方法
   */
