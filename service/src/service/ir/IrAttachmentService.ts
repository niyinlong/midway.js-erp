...
/**
 * IrAttachment 服务类
 * 处理 ir_attachment 表的数据库操作
 */
@Provide()
export class IrAttachmentService extends BaseService<IrAttachment> {
  constructor(
    @InjectRepository(IrAttachment)
    repository: Repository<IrAttachment>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询IrAttachment
   * 可以在此添加业务相关的查询方法
   */
