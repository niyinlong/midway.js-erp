...
/**
 * IrModelRelation 服务类
 * 处理 ir_model_relation 表的数据库操作
 */
@Provide()
export class IrModelRelationService extends BaseService<IrModelRelation> {
  constructor(
    @InjectRepository(IrModelRelation)
    repository: Repository<IrModelRelation>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询IrModelRelation
   * 可以在此添加业务相关的查询方法
   */
