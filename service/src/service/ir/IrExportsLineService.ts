...
/**
 * IrExportsLine 服务类
 * 处理 ir_exports_line 表的数据库操作
 */
@Provide()
export class IrExportsLineService extends BaseService<IrExportsLine> {
  constructor(
    @InjectRepository(IrExportsLine)
    repository: Repository<IrExportsLine>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询IrExportsLine
   * 可以在此添加业务相关的查询方法
   */
