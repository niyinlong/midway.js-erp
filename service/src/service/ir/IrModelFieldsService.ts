...
/**
 * IrModelFields 服务类
 * 处理 ir_model_fields 表的数据库操作
 */
@Provide()
export class IrModelFieldsService extends BaseService<IrModelFields> {
  constructor(
    @InjectRepository(IrModelFields)
    repository: Repository<IrModelFields>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询IrModelFields
   * 可以在此添加业务相关的查询方法
   */
