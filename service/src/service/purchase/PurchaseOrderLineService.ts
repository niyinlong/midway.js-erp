...
/**
 * PurchaseOrderLine 服务类
 * 处理 purchase_order_line 表的数据库操作
 */
@Provide()
export class PurchaseOrderLineService extends BaseService<PurchaseOrderLine> {
  constructor(
