...
/**
 * CrmIapLeadRole 服务类
 * 处理 crm_iap_lead_role 表的数据库操作
 */
@Provide()
export class CrmIapLeadRoleService extends BaseService<CrmIapLeadRole> {
  constructor(
    @InjectRepository(CrmIapLeadRole)
    repository: Repository<CrmIapLeadRole>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询CrmIapLeadRole
   * 可以在此添加业务相关的查询方法
   */
