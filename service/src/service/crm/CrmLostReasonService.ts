...
/**
 * CrmLostReason 服务类
 * 处理 crm_lost_reason 表的数据库操作
 */
@Provide()
export class CrmLostReasonService extends BaseService<CrmLostReason> {
  constructor(
    @InjectRepository(CrmLostReason)
    repository: Repository<CrmLostReason>
  ) {
    super(repository);
  }

  /**
   * 根据自定义条件查询CrmLostReason
   * 可以在此添加业务相关的查询方法
   */
